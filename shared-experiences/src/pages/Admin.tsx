...
export function AdminContent({ onSessionExpired, onLogout }: { onSessionExpired: () => void; onLogout: () => void }) {
  ...
  React.useEffect(() => {
    ...
    document.title = "Admin â Shared Experiences â Richard Sterling Jackson";
      ...
      {timeoutWarning && (
        ...
        <div className="mb-6 max-w-5xl mx-auto p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          ...
          <p className="text-sm text-yellow-800">
            ...
            ?? Your session will expire in 3 minutes due to inactivity. Move your mouse or click to extend your session.
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">
                  ...
                  {uploadingImage ? "Uploadingâ¦" : "JPG/PNG"}
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
            ...
            <div className="flex flex-1 flex-col sm:flex-row gap-2">
              ...
              >
                ...
                {restoring ? "Restoringâ¦" : "Restore Backup"}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 bg-card border border-border rounded-lg p-4">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setHomeFeatured({ ...homeFeatured, bubbleDescription: e.target.value })
                  }
                  rows={2}
                />
                <p className="text-xs text-muted-foreground">
